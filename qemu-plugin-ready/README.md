...
```sh
qemu-system-x86_64 -plugin target/release/libqemu_plugin_ready.dylib,port=245,fd=<PIPE_SENDER_FD>
```
...
port 245 (0xf5) addressed as a imm8 immediate.  That is: executing the following
